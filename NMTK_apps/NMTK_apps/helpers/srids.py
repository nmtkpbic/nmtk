...
#
# This is copied (almost exactly) from django.contrib.gis.utils - that
# module, however, uses the default connection 
# to create the srs - which isn't acceptable to us, since we
# might use a different database entry (rather than the default).
# This overrides that by creating a queryset object directory
# thereby bypassing the manager.
#
# We can likely remove this if/when GeoDjango corrects the bug.
#
# - Chander Ganesan
